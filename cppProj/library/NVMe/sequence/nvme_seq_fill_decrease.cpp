...
bool
NVMeSeqFillDecrease::new_plan_before_issue(IoExPlan *plan)
{
    uint32_t *bufPtr;
    int pattern;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
NVMeSeqFillDecrease::NVMeSeqFillDecrease(uint8_t nthDev, uint8_t nsid, uint64_t slba, uint64_t nlb
...
{
    rep << LegacyString().sprintf("Sequential Fill Disk Decrease : slba=0x%lX, nlb=0x%lX\n", slba, nlb);
}
//---------------------------------------------------------------------------
NVMeSeqFillDecrease::NVMeSeqFillDecrease(std::string devPath, uint64_t slba, uint64_t nlb
    , uint32_t pattern, uint32_t interval, uint32_t qDepth, uint64_t timeStamp)
...
//---------------------------------------------------------------------------
NVMeSeqFillDecrease::~NVMeSeqFillDecrease(void)
{
