...
//---------------------------------------------------------------------------
void
NVMeSeqReadCompareDecrease::golden_pattern_build(IoExPlan *plan)
{
    uint32_t *bufPtr;
    int pattern;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
NVMeSeqReadCompareDecrease::NVMeSeqReadCompareDecrease(uint8_t nthDev, uint8_t nsid, uint64_t slba
...
//---------------------------------------------------------------------------
NVMeSeqReadCompareDecrease::NVMeSeqReadCompareDecrease(std::string devPath, uint64_t slba
    , uint64_t nlb, uint32_t pattern, uint32_t interval, uint32_t qDepth, uint64_t timeStamp
    , std::string log, std::string desc)
...
//---------------------------------------------------------------------------
NVMeSeqReadCompareDecrease::~NVMeSeqReadCompareDecrease(void)
{
