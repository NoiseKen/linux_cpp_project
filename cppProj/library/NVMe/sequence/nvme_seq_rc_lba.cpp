...
//---------------------------------------------------------------------------
void
NVMeSeqReadCompareLba::golden_pattern_build(IoExPlan *plan)
{
    uint32_t *bufPtr;
    int pattern;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
NVMeSeqReadCompareLba::NVMeSeqReadCompareLba(uint8_t nthDev, uint8_t nsid, uint64_t slba
...
//---------------------------------------------------------------------------
NVMeSeqReadCompareLba::NVMeSeqReadCompareLba(std::string devPath, uint64_t slba
    , uint64_t nlb, uint32_t qDepth, uint64_t timeStamp, std::string log, std::string desc)
    : NVMeSeqReadCompare(devPath, slba, nlb, qDepth, timeStamp, log, desc)
{
}
//---------------------------------------------------------------------------
NVMeSeqReadCompareLba::~NVMeSeqReadCompareLba(void)
{
