...
//---------------------------------------------------------------------------
void
NVMeTaskFillDecrease::pre_fill_after_issue(IoExPlan *plan)
{
    //predict next plan
...
bool
NVMeTaskFillDecrease::new_plan_before_issue(IoExPlan *plan)
{
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
NVMeTaskFillDecrease::NVMeTaskFillDecrease(uint8_t nthDev, uint8_t nsid, uint64_t slba, uint64_t nlb
...
{
    rep << LegacyString().sprintf("Fill Disk Decrease : slba=0x%lX, nlb=0x%lX\n", slba, nlb);
}
//---------------------------------------------------------------------------
NVMeTaskFillDecrease::NVMeTaskFillDecrease(std::string devPath, uint64_t slba, uint64_t nlb
    , uint32_t pattern, uint32_t interval, uint32_t qDepth, uint64_t timeStamp)
...
//---------------------------------------------------------------------------
NVMeTaskFillDecrease::~NVMeTaskFillDecrease(void)
{
