...
//---------------------------------------------------------------------------
void
NVMeTaskReadCompareIncrease::golden_pattern_build(IoExPlan *plan)
{
    uint32_t *bufPtr;
    int pattern;
...
//---------------------------------------------------------------------------
//---------------------------------------------------------------------------
NVMeTaskReadCompareIncrease::NVMeTaskReadCompareIncrease(uint8_t nthDev, uint8_t nsid, uint64_t slba
...
//---------------------------------------------------------------------------
NVMeTaskReadCompareIncrease::NVMeTaskReadCompareIncrease(std::string devPath, uint64_t slba
    , uint64_t nlb, uint32_t pattern, uint32_t interval, uint32_t qDepth, uint64_t timeStamp
    , std::string log, std::string desc)
...
//---------------------------------------------------------------------------
NVMeTaskReadCompareIncrease::~NVMeTaskReadCompareIncrease(void)
{
